class Physics {
    ...
    isMouseCollidingWithComponent(component, event, mouseVelocity) {
        ...
        const bottomRightCorner = {
            x: Math.round(position.x + component.getWidth()) + 10,
            y: Math.round(position.y + component.getHeight()) + 10
        };
        ...
        if (doesMouseIntersect) {
            component.setVelocity((mouseVelocity.x * this.mouseMass) / mass,
                (mouseVelocity.y * this.mouseMass) / mass);
